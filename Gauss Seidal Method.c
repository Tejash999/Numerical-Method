...
// #include<conio.h>
#include<math.h>
/* Arrange systems of linear equations to be solved in diagonally dominant form and form
...
int main()
{
float x0=0, y0=0, z0=0, x1, y1, z1, e1, e2, e3, e=0.0001; //declaring variable with initial guess...
int count=1;
